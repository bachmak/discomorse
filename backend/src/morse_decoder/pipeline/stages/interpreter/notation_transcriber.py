...
class NotationTranscriber(OneToOneStage[MorseSymbol, Transcription]):
    """Reads the normalized symbols back out as morse notation.
    ...
    def process_single(self, symbol: MorseSymbol) -> Transcription:
